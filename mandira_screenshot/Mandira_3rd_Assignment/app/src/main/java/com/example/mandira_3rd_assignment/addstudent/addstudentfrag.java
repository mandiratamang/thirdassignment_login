package com.example.mandira_3rd_assignment.addstudent;
...
public class addstudentfrag extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        final View view = inflater.inflate(R.layout.frag_addstudent,container,false);
        ...
        Register.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(getActivity(),"Student details save",Toast.LENGTH_LONG).show();
